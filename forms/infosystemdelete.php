...
if ((isset($_GET['InfoSystemid'])) && ($_GET['InfoSystemid'] != "")) {
  $deleteSQL = sprintf("DELETE FROM infosystems WHERE InfoSystemid=%s",
                       GetSQLValueString($_GET['InfoSystemid'], "int"));

  mysql_select_db($database_auditdata, $auditdata);
  $Result1 = mysql_query($deleteSQL, $auditdata) or die(mysql_error());
}
?>
