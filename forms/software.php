...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO software (SoftwareItem, version, LicenseType, NumberofLicenses, submittedBy) VALUES (%s, %s, %s, %s, %s)",
...
$rows2 = mysql_fetch_array($result2);
	...
	$query_emprecord = "SELECT * FROM software WHERE submittedBy IN (SELECT username FROM users WHERE campus_unit LIKE '".$rows2['campus_unit']."') ORDER BY swid DESC";
...
<h1><a href="server.php">Servers</a> | <a href="network.php">Network and Telecommunications</a> | Software | <a href="manpower.php">Personnel</a></h1>

<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1" onsubmit="MM_validateForm('SoftItem','','R','version','','R','LicenseType','','R','NumberofLicenses','','R');return document.MM_returnValue">
  <table align="center">
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      <td width="188" height="22" align="right" nowrap="nowrap">Software:</td>
      <td width="428">
      <input type="text" name="SoftwareItem" value="" size="60" /></td>
    </tr>
    <tr valign="baseline">
      <td align="right" nowrap="nowrap">Version:</td>
      <td><input type="text" name="version" value="" size="10" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Type of License: </td>
    ...
    <tr valign="baseline">
      <td height="22" align="right" nowrap="nowrap">Number of Licenses:</td>
      <td><input type="text" name="NumberofLicenses" value="" size="10" /></td>
    </tr>
    <tr valign="baseline">
...
<?php } else do { ?>
  <tr class="row-a" valign="top">
    <td><?echo ++$count;?></td>
    <td height="27"><div align="center"><?php echo $row_emprecord['SoftwareItem']; ?></div></td>
    <td><div align="center">
      <?php echo $row_emprecord['version']; ?>
    </div></td>
    <td><div align="center"><?php echo $row_emprecord['LicenseType']; ?></div></td>
    <td><div align="center"><?php echo $row_emprecord['NumberofLicenses']; ?></div></td>
    <td><table>
	<tr>
	    <td><div align="center"><a href="softwareupdate.php?swid=<?php echo $row_emprecord['swid']; ?>"  rel="facebox">Update</a></div></td>
	    <td><div align="center"><a href="softwaredelete.php?swid=<?php echo $row_emprecord['swid']; ?>" onclick="return confirm('Continue Delete?')">Delete</a></div></td>
	</tr></table>
    </td> 
  </tr>
